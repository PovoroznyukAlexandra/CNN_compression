...
from vgg16_test import test_accuracy, model_compression_ratio
...
def compress_vgg16_rsvd(original_model):
    ...
    rsvd_ranks = {'linear1': 16, 'linear2': 70}
...
if __name__ == '__main__':
    ...
    torch.save(rsvd_compressed_model.state_dict(), "weights/vgg16_rsvd.pth")
